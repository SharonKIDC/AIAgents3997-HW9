...
- **Observations**:
  - Massive improvement from 50% → 83% confidence
...
- `results/figures/improvement_chart.png` - Improvement over baseline
- `results/figures/fake_frame_ratio.png` - Frame-level detection consistency
- `results/figures/research_summary.png` - Overall research summary dashboard
